...
- name: Google URL Shortener API
  description: The Google URL Shortener at goo
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/google-shortener.png
  humanURL: ""
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/links/master/_listings/google-url-shortener/url-history-get.md
x-common:
- type: x-developer
