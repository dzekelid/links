...
created: "2018-02-25"
modified: "2018-02-25"
url: https://raw.githubusercontent.com/streamdata-gallery/links/master/_listings/google-search-console/apis.yaml
...
- name: Google URL Testing Tools API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/links/master/_listings/google-search-console/v1-urltestingtools-mobilefriendlytest-run-post.md
x-common:
- type: x-blog
